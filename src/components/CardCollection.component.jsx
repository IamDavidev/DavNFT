...
const CardCollection = ({ banner, name, creator, image, address }) => {
	return (
		<article className='w-full rounded-2xl sm:w-[30%] overflow-hidden relative z-50  p-4'>
			<div className='  bg-dark  flex rounded-2xl flex-row items-center justify-start gap-5'>
				<img
					src={banner}
					alt={name}
